          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                ...
                aria-label="WhatsApp — Interakktive Hub"
              >
                <WhatsAppIcon className="w-5 h-5" />
              </a>
              <a
                href="https://discord.gg/kzrcwN7DVT"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Discord"
              ...
              <a
                href="https://www.youtube.com/@Interakktive"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="YouTube"
              ...
              <a
                href="https://www.instagram.com/interakktive/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a
                href="https://www.tiktok.com/@interakktive"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="TikTok"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61577447110648"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Facebook"
