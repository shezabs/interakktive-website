...
const gameRounds = [
  {
    ...
    options: [
      ...
      { text: 'Nothing yet &mdash; a standalone arrow is a conclusion without a visible diagnosis. Without regime, score, and narrative behind it, it is a claim with no evidence you can evaluate.', correct: true, explain: 'Exactly right. The problem isn&apos;t that an indicator drew an arrow &mdash; the problem is that the arrow appeared without a visible diagnostic cascade behind it. ATLAS&apos;s PRO tier (CIPHER PRO, for example) DOES produce signals, but only as transparent conclusions of the free-tier cascade you learn in Level 10. An arrow you can trace back through regime, score, and narrative is a disciplined conclusion. An arrow without that chain is marketing, not intelligence.' },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Indicator B &mdash; it provides state (teal/bullish), score (64), and narrative (pullback entries). That is diagnostic intelligence, not signal spam.', correct: true, explain: 'Exactly right. Indicator B is showing the ATLAS way: color language encoding state, a quantified score encoding strength, and a narrative encoding meaning. Level 10&apos;s free-tier indicators stop here by design &mdash; diagnosis without a trigger. The PRO tier (Level 11) layers triggers on top of this exact cascade, so when an arrow does appear, it is the diagnosis&apos;s visible conclusion rather than a claim stripped of context.' },
    ],
  },
  {
    ...
    <div className="min-h-screen text-white" style={{ background: 'linear-gradient(to bottom, #060a12, #0a0f1a)' }}>
      ...
      <section className="max-w-2xl mx-auto px-5 py-20">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <div className="p-6 rounded-2xl glass-card mb-6">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">The trading indicator industry is built on a lie of omission. Every product page promises the same thing: <strong className="text-amber-400">a magic arrow that tells you when to buy and sell</strong>. Marketing shows green arrows at the bottom, red arrows at the top, and a winning trade on every example. What the marketing never shows is <strong className="text-white">WHY the arrow fired</strong>.</p>
            <p className="text-gray-400 leading-relaxed mb-4">Those arrows fire hundreds of times per week across any real chart. The <strong className="text-white">signal-to-noise ratio is catastrophic</strong>. But the deeper problem isn&apos;t the noise &mdash; it&apos;s the <em>opacity</em>. An arrow without a visible diagnostic cascade behind it is a guess dressed up as certainty. You can&apos;t evaluate it, you can&apos;t learn from it, you can&apos;t tell when to trust it and when to skip it.</p>
            <p className="text-gray-400 leading-relaxed">ATLAS was built to fix this &mdash; not by refusing signals, but by <strong className="text-amber-400">refusing unbacked signals</strong>. Level 10 teaches you the free-tier diagnostic foundation: nine indicators that measure the present market state honestly and output zero predictions. Level 11 (PRO Arsenal) then introduces signal-producing indicators like CIPHER PRO, OPTIONS PRO, and PHANTOM PRO &mdash; but only as transparent conclusions of the same visible cascade. Diagnostic-first, signals-after. That is the design commitment that changes everything.</p>
          </div>
          <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/15">
            <p className="text-xs font-bold text-amber-400 mb-2">&#128270; THE ATLAS AXIOM</p>
            <p className="text-sm text-gray-400 leading-relaxed">A signal without a visible diagnosis is a guess. A signal with a visible diagnosis is a disciplined conclusion. This is not a trading philosophy &mdash; it is an epistemological commitment. Every ATLAS indicator is built from this axiom down. The free tier holds the diagnosis at the surface; the PRO tier layers signals on top without ever hiding the diagnostic cascade underneath. That is why the suite feels different from anything else on TradingView.</p>
          </div>
        </motion.div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-5 py-16">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <p className="text-gray-400 leading-relaxed mb-6">Every indicator ever made belongs to one of two families. The retail world is dominated by <strong className="text-red-400">unbacked predictive</strong> tools &mdash; they fire arrows with no visible reasoning behind them. The institutional world runs on <strong className="text-amber-400">diagnostic-first</strong> tools &mdash; they classify current conditions transparently and let the trader see every input before any signal is drawn. The chart below shows the same price data interpreted by each approach.</p>
          <PredictiveVsDiagnosticAnim />
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="p-3 rounded-xl bg-red-500/5 border border-red-500/15">
              <p className="text-xs font-extrabold text-red-400 mb-1">Unbacked Predictive (Retail)</p>
            ...
            <div className="p-3 rounded-xl bg-amber-500/5 border border-amber-500/15">
              <p className="text-xs font-extrabold text-amber-400 mb-1">Diagnostic-First (ATLAS)</p>
              <p className="text-[11px] text-gray-400">Classifies the regime. Scores its strength. Narrates the meaning. Level 10 teaches the diagnostic layer alone; Level 11 layers signals on top &mdash; but the cascade is always visible first, always.</p>
            </div>
          </div>
        </motion.div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-5 py-16">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <p className="text-gray-400 leading-relaxed mb-6">Step back from any specific indicator for a moment and look at the <em>causal logic</em> of how trading signals should actually flow. In a well-functioning trading process: the market does something (<strong className="text-white">reality</strong>), you measure what it&apos;s doing (<strong className="text-white">diagnosis</strong>), you decide what to do about it (<strong className="text-white">conclusion</strong>). Reality &rarr; Diagnosis &rarr; Conclusion. That&apos;s the natural causal direction. <strong className="text-amber-400">Most retail indicators invert this chain.</strong> They produce the conclusion (a BUY arrow, a SELL alert) <em>without ever surfacing the diagnosis</em>, or giving you a way to verify it. The arrow might be right; you have no way to tell. That opacity is the industry&apos;s core failure mode &mdash; and the failure ATLAS is designed around.</p>
          <DiagnosticInversionAnim />
          <div className="mt-4 p-4 rounded-xl bg-amber-500/5 border border-amber-500/15">
            <p className="text-xs font-bold text-amber-400 mb-1">&#128260; The Inversion Doctrine</p>
            <p className="text-sm text-gray-400 leading-relaxed">This is why every ATLAS indicator outputs three things instead of one: a <strong className="text-white">state</strong> (the regime classification), a <strong className="text-white">score</strong> (the quantified measurement), and a <strong className="text-white">narrative</strong> (the plain-English interpretation). The free-tier indicators you&apos;ll learn across Level 10 stop there &mdash; they deliberately surface the diagnosis and leave the conclusion to you. The PRO tier (Level 11) then layers signals on top, but ONLY as transparent outputs of the same visible cascade. <strong className="text-white">An ATLAS signal is never a shortcut around the diagnosis &mdash; it is the diagnosis&apos;s visible conclusion.</strong> That commitment is what makes every tool in Level 10 &ldquo;diagnostic&rdquo; and every tool in Level 11 &ldquo;diagnostic-backed&rdquo; rather than black-box. <strong className="text-white">Every groundbreaking concept in the rest of this level &mdash; the Liquidity Handoff, the Corridor Gravity Model, the Three-Force Decomposition, the Acceptance-vs-Absorption distinction, the Volume Fallback Doctrine &mdash; is an application of this principle to a specific domain.</strong> They are not separate ideas; they are five instances of the same commitment: measure reality honestly, then let conclusions be earned.</p>
          </div>
      ...
      <section className="max-w-2xl mx-auto px-5 py-16">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <div className="space-y-3">
            {[
              { t: 'Zero Black Boxes', d: 'Every score, every state, every narrative explains its own reasoning. If a component fires, you can see why. If a regime classifies, the logic is visible. If a signal appears in the PRO tier, it is the conclusion of a cascade you can trace.' },
              { t: 'Diagnostic-First Architecture', d: 'The free tier contains zero signals by design &mdash; nine indicators that measure the present without predicting the future. The PRO tier layers signals on top, but only as transparent outputs of the free-tier cascade. Diagnosis before conclusion, always.' },
