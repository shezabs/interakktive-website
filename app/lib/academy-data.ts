...
export const academyCourses: AcademyCourse[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'cipher-pulse-factor', courseId: 'level-11-cipher-pro-mastery', title: 'The 5-Layer Pulse Factor', subtitle: 'You set one number. CIPHER reads five contexts and tunes it.', description: 'The first lesson of the Signal Engine arc. The Groundbreaking Concept — The Self-Calibrating Heartbeat — reveals that your i_pulse_factor input is a SEED, not a final value. CIPHER multiplies it through five hidden layers every bar: Timeframe (Scalp 1.00, 1H-D 0.85, Weekly 0.70), Asset Class (Stock 1.00, Index 0.95, Crypto 0.90, Forex/Commodity 0.80), Volatility (clamped 0.80-1.30 by vol_ratio), ADX/Trend Strength (chop 1.15, mid 1.00, strong 0.85 — counter-intuitive), and Active Preset (Trend 1.00, Scalper 0.80, Swing 1.20, Sniper 1.30). The composition formula (multiplication, not addition) and worked XAUUSD 1H example. Anatomy of the Pulse line itself: Cipher Flow anchor, ATR distance, raw candidate, Supertrend-style ratchet that refuses to give back ground, SMA smoothing. The maturity lifecycle (FRESH/YOUNG/ESTABLISHED/MATURE). The choppy flag detection (3+ flips in 20 bars). The slope verdict (STEEPENING/STEADY/FLATTENING). Reading the full Pulse Command Center row: 6 proximity states, 6 guidance verdicts, 4-color grammar. Six common Pulse-tuning mistakes. Earns the Pulse Factor Operator certificate.', estimatedMinutes: 50, isFree: false, totalSections: 17, quizPassThreshold: 66 },
